...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-3 left-1/2 -translate-x-1/2 w-[95%] max-w-[1400px] h-20 bg-[#e5e9f0]/95 backdrop-blur-xl border-x border-b border-white/20 rounded-[32px] flex justify-between items-center px-10 z-[1000] shadow-2xl">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link to="/cart" className="relative">
            <FaShoppingCart
              size={24}
              className="text-[#1a1a1a] hover:text-[#DA1212] transition-colors duration-300"
            />
        ...
        >
          <div
            className={`w-6 h-[2.5px] bg-[#1a1a1a] transition-all duration-300 ${
      ...
      >
        ...
        {/* Menu Content */}
        <div
          className={`absolute top-24 left-1/2 -translate-x-1/2 w-[90%] bg-[#e5e9f0] rounded-[32px] p-10 shadow-2xl transition-all duration-500 transform ${
            isOpen
        ...
        >
          <div className="flex flex-col items-center gap-8">
            ...
            <Link
              to="/cart"
              onClick={() => setIsOpen(false)}
              className="relative flex items-center gap-3 text-xl font-black uppercase tracking-[0.3em] text-[#1a1a1a]"
            >
